...
export const SITE_TITLE = "Future Voters Academy";
export const SITE_DESCRIPTION = "Future Voters Academy raises funds for free, nonpartisan civic and political education in low-income neighborhoods. Founded by Thomas Cobb.";
